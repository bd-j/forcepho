...
These set the sizes of the structs we use to communicate with the GPU.
Thus, we need to know them in Python as well.  This class parses the kernel_limits.h
