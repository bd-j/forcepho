...
from forcepho.mixtures.gaussian_psf import fit_mvn_mix
from forcepho.psf import params_to_gauss
...
def radial_profile(data, center):
    ...
    already checked that it worked.
    '''
...
if __name__ == "__main__":
    ...
    psfname = os.path.join(psfims, "PSF_NIRCam_F090W.fits")
    outdir = "./"
    band = 'f090w'
    ...
    outname = os.path.join(outdir, "{}_ng{}_em_random.p".format(band, nmix))
